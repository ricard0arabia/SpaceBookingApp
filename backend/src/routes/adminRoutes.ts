...
adminRoutes.post("/admin/bookings/:id/approve", requireCsrf, approveBookingHandler);
adminRoutes.post("/admin/bookings/:id/deny", requireCsrf, denyBookingHandler);
adminRoutes.post("/admin/bookings/:id/edit", requireCsrf, editBookingHandler);
